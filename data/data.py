data = {
    "movies": [{
        ...
        "directors": [{"name": "Тейлор Шеридан", "id": 1}, {"name": "Квентин Тарантино", "id": 2},
        {"name": "Владимир Вайншток", "id": 3}, {"name": "Декстер Флетчер", "id": 4},
        {"name": "Стив Энтин", "id": 5}, {"name": "Роб Маршалл", "id": 6}, {"name": "Баз Лурман", "id": 7},
        {"name": "Дэмьен Шазелл", "id": 8}, {"name": "Пьетро Антон", "id": 9},
        {"name": "Джеймс Мэнголд", "id": 10}, {"name": "Дени Вильнёв", "id": 11},
        {"name": "Кирилл Серебренников", "id": 12}, {"name": "Рубен Фляйшер", "id": 13},
        {"name": "Стэнли Кубрик", "id": 14}, {"name": "Ричард Келли", "id": 15},
        {"name": "Пит Доктер", "id": 16}, {"name": "Кемп Пауэрс", "id": 17},
        {"name": "Бибо Бержерон", "id": 18}, {"name": "Тоби Генкель", "id": 19},
        {"name": "Шон Маккормак", "id": 20}],
    "genres": [
        {"name": "Комедия", "id": 1}, {"name": "Семейный", "id": 2}, {"name": "Фэнтези", "id": 3},
        {"name": "Драма", "id": 4}, {"name": "Приключения", "id": 5}, {"name": "Триллер", "id": 6},
        {"name": "Фантастика", "id": 7}, {"name": "Аниме", "id": 8}, {"name": "Документальное", "id": 9},
        {"name": "Короткометражка", "id": 10}, {"name": "Ужасы", "id": 11}, {"name": "Боевик", "id": 12},
        {"name": "Мелодрама", "id": 13}, {"name": "Детектив", "id": 14}, {"name": "Авторское кино", "id": 15},
        {"name": "Мультфильм", "id": 16}, {"name": "Вестерн", "id": 17}, {"name": "Мюзикл", "id": 18}],
    "users": [
        {"username": "Test", "id": 1, "password": "5ET7nV4bC14Z9Ks7LvapBxb65R2W", "role": 'admin'}],
